    ...
    def analyze(self):
        ...
        for i in range(self.nx):
            for j in range(self.ny):
                _x = self.xcoords[i] - self.xc
                _y = self.ycoords[j] - self.yc
...
row = 0 ;   col = 0
tk.Label(tab3,text='Anchor Group Analysis',font=large).grid(row=row,column=col,sticky="NW")
row += 1
tk.Label(tab3,text=' ',font=large).grid(row=row,column=col,sticky="NW")
row += 1
...
tk.Label(tab3,text='Anchor Group Properties',font=medbold).grid(row=row,column=col,sticky="NW")
row += 1
tk.Label(tab3,text='Number of Anchors in the X direction, nx =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=input_nx,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
tk.Label(tab3,text='Anchor spacing in the X direction (in), s1 =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=input_s1,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
tk.Label(tab3,text='Number of Anchors in the Y direction, ny =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=input_ny,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
tk.Label(tab3,text='Anchor spacing in the Y direction (in), s2 =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=input_s2,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
tk.Label(tab3,text='Moment of Inertia about the Y-Y axis (in4), Iy =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=out_Iy,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
tk.Label(tab3,text='Moment of Inertia about the X-X axis (in4), Ix =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=out_Ix,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
tk.Label(tab3,text='Polar Moment (in4), Ip =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=out_Ip,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
...
tk.Label(tab3,text='Tension, X-X Axis',font=medbold).grid(row=row,column=col,sticky="NW")
row += 1
tk.Label(tab3,text='Uniform Tension Per Anchor from FZ (kip) =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=out_TxFZ,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
tk.Label(tab3,text='Max. Tension Due to MY (kip) =',font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab3,textvariable=out_TxMY,font=medium,state="readonly",relief="solid",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col -= 1
...
tk.Label(tab2,text=" ",font=large).grid(row=0,column=2)

row = 0 ;   col = 0

tk.Label(tab2,text="Output",font=large).grid(row=row,column=col,sticky="NW")
row += 1    
...
tk.Label(tab2,text="Minimum Spacing and Edge Distances (§17.9.2)",font=medbold).grid(row=row,column=col,sticky="NE")
row += 1
tk.Label(tab2,text="Minimum Spacing, smin (in) =",font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab2,textvariable=out_smin,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text="Minimum Edge Distance, cmin (in) =",font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab2,textvariable=out_cmin,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text="Critical Edge Distance, cac (in) =",font=medium).grid(row=row,column=col,sticky="NE")
col +=1
tk.Entry(tab2,textvariable=out_cac,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text=" ",font=medium).grid(row=row,column=col,sticky="NW")
row +=1

# Results for 17.6.1
tk.Label(tab2,text="Steel Strength of Anchor in Tension (§17.6.1)",font=medbold).grid(row=row,column=col,sticky="NE")
# row +=1 
...
# tk.Label(tab2,text="AseN (in2) =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_AseN,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
# tk.Label(tab2,text="futa (ksi) =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_futa,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text="Nsa (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Nsa,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text="𝜙Nsa (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_f_Nsa,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text="Nsa / Ω (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Nsa_W,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text=" ",font=large).grid(row=row,column=col,sticky="NE")
row += 1    ;   col = 0


# Results for 17.6.2
tk.Label(tab2,text="Concrete Breakout Strength of Anchor in Tension (§17.6.2)",font=medbold).grid(row=row,column=col,sticky="NE")
# row +=1 
out_ANc = tk.DoubleVar()
# # tk.Label(tab2,text="ANc (in2) =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_ANc,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
out_ANco = tk.DoubleVar()
# tk.Label(tab2,text="ANco (in2) =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_ANco,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
out_yecN = tk.DoubleVar()
# tk.Label(tab2,text="𝜓ecN =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_yecN,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
out_yedN = tk.DoubleVar()
# tk.Label(tab2,text="𝜓edN =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_yedN,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
out_ycN = tk.DoubleVar()
# tk.Label(tab2,text="𝜓cN =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_ycN,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
out_ycpN = tk.DoubleVar()
# tk.Label(tab2,text="𝜓cpN =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_ycpN,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
out_Nb = tk.DoubleVar()
# tk.Label(tab2,text="Nb (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_Nb,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
out_Ncb = tk.DoubleVar()
tk.Label(tab2,text="Single Anchor, Ncb (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Ncb,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
out_f_Ncb = tk.DoubleVar()
tk.Label(tab2,text="Single Anchor, 𝜙Ncb (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_f_Ncb,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
out_Ncb_W = tk.DoubleVar()
tk.Label(tab2,text="Single Anchor, Ncb / Ω (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Ncb_W,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
out_Ncbg = tk.DoubleVar()
tk.Label(tab2,text="Anchors as a Group, Ncbg (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Ncbg,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
out_f_Ncbg = tk.DoubleVar()
tk.Label(tab2,text="Anchors as a Group, 𝜙Ncb (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_f_Ncbg,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
out_Ncbg_W = tk.DoubleVar()
tk.Label(tab2,text="Anchors as a Group, Ncb / Ω (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Ncbg_W,font=medium,state="readonly",width=8,relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text=" ",font=large).grid(row=row,column=col,sticky="NE")
row += 1    ;   col = 0

# Results for 17.6.3
tk.Label(tab2,text="Pullout Strength of a Single CI or PI Anchor in Tension (§17.6.3)",font=medbold).grid(row=row,column=col,sticky="NE")
row +=1 
out_Np = tk.StringVar()
...
# tk.Label(tab2,text="Np (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_Np,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
# tk.Label(tab2,text="𝜓cP =", font=medium).grid(row=row,column=col,sticky="NE")
# col += 1
# tk.Entry(tab2,textvariable=out_ycP,font=medium,state="readonly",width=8).grid(row=row,column=col,sticky="NW")
# row += 1    ;   col = 0
tk.Label(tab2,text="Npn (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Npn,font=medium,state="readonly",width=8, relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text="𝜙Npn (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_f_Npn,font=medium,state="readonly",width=8, relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text="Npn / Ω (kip) =", font=medium).grid(row=row,column=col,sticky="NE")
col += 1
tk.Entry(tab2,textvariable=out_Npn_W,font=medium,state="readonly",width=8, relief="solid").grid(row=row,column=col,sticky="NW")
row += 1    ;   col = 0
tk.Label(tab2,text=" ", font=medium).grid(row=row,column=col,sticky="NE")
row += 1    ;   col = 0
