...
class App:
    ...
    def build_window(self):
        ...
        # Big entry window
        ctk.CTkEntry(master=self.root, width=240,
                     font=("Consolas", 36), textvariable=self.input).pack(side="top", fill="both")

        # Big convert button
        ctk.CTkButton(master=self.root, text="CONVERT", command=self.click,
                      width=240, font=("Consolas", 36, "bold")).pack(fill="both")
